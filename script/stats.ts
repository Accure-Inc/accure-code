...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Accure-Inc/accure-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Accure-Inc/accure-code...\n")
