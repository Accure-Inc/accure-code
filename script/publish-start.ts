...
const skipNotes = process.env["ACCURECODE_SKIP_NOTES"] === "1" // accurecode_change
if (skipNotes) console.log("changelog skipped: ACCURECODE_SKIP_NOTES=1") // accurecode_change
...
if (!Script.preview) {
  ...
  // accurecode_change start - skip draft flag when ACCURECODE_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
