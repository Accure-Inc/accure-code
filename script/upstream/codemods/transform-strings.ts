 ...
 *
 * Transforms string literals containing opencode references to accure:
 * - "opencode-ai" -> "@accurecode/cli"
 * - "npx opencode" -> "npx @accurecode/cli"
 * - etc.
 *
 * Usage:
...
const STRING_REPLACEMENTS: StringReplacement[] = [
  ...
  { pattern: /\bopencode-ai\b/g, replacement: "@accurecode/cli" },
  ...
  // CLI commands
  { pattern: /\bnpx opencode\b/g, replacement: "npx @accurecode/cli" },
  { pattern: /\bbun add opencode\b/g, replacement: "bun add @accurecode/cli" },
  { pattern: /\bnpm install opencode\b/g, replacement: "npm install @accurecode/cli" },
  { pattern: /\bnpm i opencode\b/g, replacement: "npm i @accurecode/cli" },

  // Database filename
  { pattern: /\bopencode\.db\b/g, replacement: "accure.db" },

  // Binary name references (be careful with these)
  { pattern: /\bopencode upgrade\b/g, replacement: "accure upgrade" },
  ...
  { pattern: /\bVITE_OPENCODE_/g, replacement: "VITE_ACCURECODE_" },
  { pattern: /\b_EXTENSION_OPENCODE_/g, replacement: "_EXTENSION_ACCURECODE_" },
]
