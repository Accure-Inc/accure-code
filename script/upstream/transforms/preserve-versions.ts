#!/usr/bin/env bun
/**
 * Preserve Accure package versions during upstream merge
 *
 * This script ensures that Accure's package versions are not overwritten
...
/**
 * Get the current Accure version from the main package.json
 */
