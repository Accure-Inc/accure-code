...
Generates UPCOMING_CHANGELOG.md by running the accure changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for accure run (default: low)
      --quiet            Suppress accure command output unless it fails
...
const cmd = ["accure", "run"] // accurecode_change - opencode -> accure
