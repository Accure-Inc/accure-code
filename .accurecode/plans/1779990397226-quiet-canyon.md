...
- The relevant files are `packages/accure-jetbrains/frontend/src/main/kotlin/ai/accurecode/client/session/SessionUi.kt`, `.../scroll/SessionScroll.kt`, `.../views/question/QuestionView.kt`, `.../views/permission/PermissionView.kt`, `.../views/LoginRequiredView.kt`, `.../views/base/BaseQuestionView.kt`, and `frontend/src/test/kotlin/ai/accurecode/client/session/SessionScrollTest.kt`.
...
- From `packages/accure-jetbrains/`, run `./gradlew test --tests "ai.accurecode.client.session.SessionScrollTest"`.
- From `packages/accure-jetbrains/`, run `./gradlew typecheck`.
