...
## Findings
- Runtime colorization exists only in `frontend/src/main/kotlin/ai/accurecode/client/ui/SvgIconColorizer.kt`.
- The only production caller is `frontend/src/main/kotlin/ai/accurecode/client/session/scroll/ScrollButtonIcon.kt`.
...
- Other used frontend icons already have light/dark pairs:
  ...
  - `accure.svg` / `accure_dark.svg`
  - `accure-content.svg` / `accure-content_dark.svg`
  - `plus.svg` / `plus_dark.svg` exists, though no current direct source reference was found.
  - `accure@20x20.svg` / `accure@20x20_dark.svg` exists, though no current direct source reference was found.
...
2. Delete `frontend/src/main/kotlin/ai/accurecode/client/ui/SvgIconColorizer.kt` after confirming no callers remain.
...
6. Run the smallest relevant verification from `packages/accure-jetbrains/`:
   - `bun run typecheck` or `./gradlew typecheck`.

## Files Expected To Change
- `packages/accure-jetbrains/frontend/src/main/kotlin/ai/accurecode/client/session/scroll/ScrollButtonIcon.kt`
- `packages/accure-jetbrains/frontend/src/main/kotlin/ai/accurecode/client/session/ui/style/SessionUiStyle.kt`
- Delete `packages/accure-jetbrains/frontend/src/main/kotlin/ai/accurecode/client/ui/SvgIconColorizer.kt`
- Add `packages/accure-jetbrains/src/main/resources/META-INF/pluginIcon_dark.svg`
