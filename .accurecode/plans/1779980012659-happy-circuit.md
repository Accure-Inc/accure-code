...
- [ ] Confirm whether the change belongs in Accure-owned code or shared upstream code.
...
- Prefer Accure-owned directories for Accure-specific behavior.
- If shared upstream files must be edited, keep the change narrow and add `accurecode_change` markers where required.
