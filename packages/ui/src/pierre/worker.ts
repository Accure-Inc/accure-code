...
import { ensureAccureDiffTheme, ACCURECODE_DIFF_THEME } from "./accure-diff-theme" // accurecode_change

// accurecode_change start: register the "Accure" theme as a precondition of creating
...
// loader for Accure". Doing it here means every diff component (which imports this
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Accure, as I think 8 might be
      // a bit overkill, especially because Safari has a significantly slower
      // boot up time for workers
      poolSize: 2,
    },
    {
      theme: ACCURECODE_DIFF_THEME, // accurecode_change
      lineDiffType,
