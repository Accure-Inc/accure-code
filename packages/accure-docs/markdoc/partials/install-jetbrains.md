Accure Code supports all JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, and more.

### Prerequisites

Before installing the Accure Code plugin, ensure you have:
...
2. Then, you can click the button below to install Accure Code directly from the JetBrains Marketplace:

[![Install Accure Code](https://raster.shields.io/badge/Install%20Accure%20Code-F8F674?style=for-the-badge)](https://plugins.jetbrains.com/plugin/28350-accure-code)
...
Follow the [v7 roadmap and release milestone](https://github.com/Accure-Inc/accure-code/milestone/1) for planned work and release progress.

{% callout type="info" %}
The v7 EAP plugin is compatible with JetBrains IDE builds 261 and later. EAP builds update frequently, so we recommend enabling automatic plugin updates in your JetBrains IDE from **Settings/Preferences → System Settings → Updates → Update plugins automatically**. Share feedback in the JetBrains channel on the [Accure Discord](https://accure.ai/discord).
{% /callout %}
