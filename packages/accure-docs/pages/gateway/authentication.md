...
API keys are JWT tokens tied to your Kilo account. See [how to get your API key](/docs/getting-started/setup-authentication#accure-gateway-api-key) for step-by-step instructions.
