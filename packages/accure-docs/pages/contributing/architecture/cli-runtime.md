...
| Console | `packages/accure-console/`{% linebreak /%}`packages/opencode/src/kilocode/console/` |
| Indexing | `packages/accure-indexing/`{% linebreak /%}`packages/opencode/src/kilocode/indexing.ts` |
