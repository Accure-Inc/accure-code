...
As you work with Accure Code, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the Accure Code settings panel:
...
- **macOS**: `~/Library/Application Support/Code/User/globalStorage/accurecode.accurecode-code/`
- **Windows**: `%APPDATA%\Code\User\globalStorage\accurecode.accurecode-code\`
- **Linux**: `~/.config/Code/User/globalStorage/accurecode.accurecode-code/`
