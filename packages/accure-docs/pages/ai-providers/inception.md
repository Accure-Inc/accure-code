---
title: "Using Inception Labs with Accure Code"
description: "Connect Inception Labs' Mercury diffusion LLMs to Accure Code for ultra-fast code generation. Setup guide for VS Code and the CLI."
sidebar_label: Inception
---

# Using Inception With Accure Code
...
3. **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "Accure Code").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

Accure Code supports Inception's available models. Model selection and capabilities may vary based on your account tier.
...
- **Docs Feedback:** Report documentation issues at [Accure-Inc/accure-code issues](https://github.com/Accure-Inc/accure-code/issues/new?title=Documentation%20Issue:%20/docs/ai-providers/inception).
