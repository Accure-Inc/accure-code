---
title: "Using MiniMax with Accure Code"
description: "Configure MiniMax AI models in Accure Code. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: MiniMax
---

# Using MiniMax With Accure Code
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., "Accure Code").
