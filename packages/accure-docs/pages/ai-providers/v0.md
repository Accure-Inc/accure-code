---
title: "Using Vercel v0 with Accure Code"
description: "Connect Vercel's v0 models to Accure Code for UI-focused code generation. Setup guide for VS Code and the CLI."
sidebar_label: v0
---

# Using v0 With Accure Code

Accure Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Accure Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Accure Code, you'll need:
...
Setting up v0 in Accure Code is straightforward:

1. In Accure Code settings (click the {% codicon name="gear" /%} icon):
...
<!-- <img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Accure Code settings" width="600" /> -->
