---
title: "Using DeepSeek with Accure Code"
description: "Connect DeepSeek's reasoning and coding models to Accure Code. Setup guide for DeepSeek-V3 and DeepSeek-R1 in VS Code and the CLI."
sidebar_label: DeepSeek
---

# Using DeepSeek With Accure Code

Accure Code supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
