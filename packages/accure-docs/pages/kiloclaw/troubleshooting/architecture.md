...
description: "How AccureClaw instances are structured"
---

# Architecture Notes

For advanced users — how AccureClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Accure controller.
