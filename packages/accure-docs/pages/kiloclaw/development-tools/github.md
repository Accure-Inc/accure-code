...
description: "Connect a GitHub account to your AccureClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your AccureClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
AccureClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `accureclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in AccureClaw
...
AccureClaw accepts both GitHub token formats:
...
When your instance starts, AccureClaw automatically:
...
- Tokens are encrypted at rest using AccureClaw's secret management system
