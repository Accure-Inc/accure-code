...
description: "Connect Linear to your AccureClaw agent to create and manage issues automatically"
---

# Linear Integration

Connect Linear to your AccureClaw agent so it can create issues, update their status, read project backlogs, and track work — all automatically. Linear is a project management tool popular with software teams for planning and tracking features, bugs, and tasks.
...
- A **Linear account** with access to the workspace you want AccureClaw to use
...
4. Click **Create key**
5. Give the key a descriptive label (for example, `accureclaw-bot`) and click **Create**
...
Once connected, your AccureClaw agent can interact with Linear on your behalf:
