...
description: "Connect your AccureClaw agent to 1Password to securely manage credentials"
---

# 1Password Integration Guide

Connect your AccureClaw agent to 1Password to securely manage credentials. This allows your agent to fetch API keys or passwords without ever seeing them in plain text.
...
2. Create a **New Vault** (e.g., name it `Accure-Agent-Vault`).
...
## Step 3: Configure AccureClaw

1. Navigate to your AccureClaw dashboard: [app.accurecode.ai/claw](https://app.accurecode.ai/claw).
