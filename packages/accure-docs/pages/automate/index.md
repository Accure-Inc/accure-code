---
title: "Automate"
description: "Automate your development workflows with Accure Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Accure Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Accure Code to external tools and services:
...
- [**Using MCP in Accure Code**](/docs/automate/mcp/using-in-accure-code) — Configuration guide
...
Connect Accure Code with your development tools:
...
Customize and extend Accure Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-accure-code) for external integrations
