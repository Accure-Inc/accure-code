...
## Why Accure Code Uses MCP

Accure Code leverages MCP to provide:
...
MCP creates a universal connector between Accure Code and external services, with REST APIs often powering those services behind the scenes.
