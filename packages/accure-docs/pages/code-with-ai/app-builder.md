---
title: "App Builder"
description: "Build complete applications with Accure Code"
---

# App Builder

Accure's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Accure dashboard. No local environment setup required.
...
- **Active Accure Code account**  
  Sign up or log in at [app.accurecode.ai](https://app.accurecode.ai)

---

## Cost

- You pay only for the AI model usage via Accure Code credits
...
1. Navigate to **[App Builder](https://app.accurecode.ai/app-builder)** from your Accure dashboard.
