...
This information lets Accure show your recent sessions and continue right from the same context the next time you open it.
...
3. Interact with Accure via any of our interfaces- the CLI, the Cloud Agent, or the Extensions in your favorite IDE.
...
To keep sessions fast and resumable, Accure stores small JSON blobs associated with your session. These include your conversation history and task metadata. If you share a session, Accure keeps a public copy used by the share link while your private session remains under your account.
