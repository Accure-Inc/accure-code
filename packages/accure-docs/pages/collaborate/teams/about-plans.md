---
title: "About Plans"
description: "Overview of Accure Code plans and pricing"
---

# About Plans

Accure Code accelerates development with AI-driven code generation and task automation. You can use Accure Code as an open source extension in VS Code or JetBrains IDEs.
...
Accure Code's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Accure Code's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Accure Teams
...
## What You Get from Accure Enterprise
...
**Cost:** [Contact Sales](https://accure.ai/contact-sales)
