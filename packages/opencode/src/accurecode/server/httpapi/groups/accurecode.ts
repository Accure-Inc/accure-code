...
export const AccurecodePaths = {
  heapSnapshot: `${root}/heap/snapshot`,
  removeSkill: `${root}/skill/remove`,
  removeAgent: `${root}/agent/remove`,
} as const

export const AccurecodeApi = HttpApi.make("accurecode")
  .add(
    HttpApiGroup.make("accurecode")
      .add(
        HttpApiEndpoint.post("heapSnapshot", AccurecodePaths.heapSnapshot, {
          query: WorkspaceRoutingQuery,
          success: described(Schema.String, "Heap snapshot file path"),
          error: HttpApiError.BadRequest,
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "accurecode.heap.snapshot",
            summary: "Write heap snapshot",
            description: "Write a heap snapshot for the CLI process to the log directory.",
          }),
        ),
        HttpApiEndpoint.post("removeSkill", AccurecodePaths.removeSkill, {
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "accurecode.removeSkill",
            summary: "Remove a skill",
            description: "Remove a skill by deleting its manifest from disk and clearing it from cache.",
          }),
        ),
        HttpApiEndpoint.post("removeAgent", AccurecodePaths.removeAgent, {
          query: WorkspaceRoutingQuery,
          ...
          OpenApi.annotations({
            identifier: "accurecode.removeAgent",
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "accurecode",
          description: "Accure-specific routes.",
        }),
      )
