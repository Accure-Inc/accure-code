...
import type { AccurecodeProfile, AccurecodeBalance } from "@accurecode/accure-gateway"

interface DialogAccureProfileProps {
  profile: AccurecodeProfile
  balance: AccurecodeBalance | null
  currentOrgId?: string | null
}

export function DialogAccureProfile(props: DialogAccureProfileProps) {
  ...
  const usageUrl = props.currentOrgId
    ? `https://app.accurecode.ai/organizations/${props.currentOrgId}/usage-details`
