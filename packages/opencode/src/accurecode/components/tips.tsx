...
const TIPS = [
  ...
  "Accure can {highlight}configure itself{/highlight} if you ask it",
  "Ask Accure to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Accure to {highlight}create a review agent for this project{/highlight}",
  "Ask Accure to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Accure to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Accure to {highlight}make my review agent read-only{/highlight}",
  "Ask Accure to {highlight}require approval before git push{/highlight}",
  "Ask Accure to {highlight}turn off auto-formatting{/highlight}",
  "Ask Accure to {highlight}block access to .env files{/highlight}",
  "Ask Accure to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Accure to {highlight}match my terminal theme{/highlight}",
  "Ask Accure to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Accure to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Accure to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Accure to {highlight}save this workflow as a /command{/highlight}",
  "Accure auto-handles OAuth for remote MCP servers requiring auth",
  "Accure auto-formats files using prettier, gofmt, ruff, and more",
  "Accure uses LSP servers for intelligent code analysis",
