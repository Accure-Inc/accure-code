 ...
 *   {
 *     password: Config.string("ACCURECODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ACCURECODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
