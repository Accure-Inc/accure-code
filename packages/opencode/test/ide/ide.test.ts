...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ACCURECODE_CALLER", () => {
    process.env["ACCURECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ACCURECODE_CALLER", () => {
    process.env["ACCURECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ACCURECODE_CALLER", () => {
    process.env["ACCURECODE_CALLER"] = "unknown"
