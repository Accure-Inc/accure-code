  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@accurecode%2fcli/${InstallationChannel}`) // accurecode_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@accurecode%2fcli/${InstallationChannel}`) // accurecode_change
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@accurecode%2fcli/${InstallationChannel}`) // accurecode_change
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("Accure-Org/tap/accure")) return "" // accurecode_change
          if (cmd === "brew" && args.includes("--formula") && args.includes("accure")) return "accure" // accurecode_change
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("Accure-Org/tap/accure") && args.includes("--formula")) return "accure" // accurecode_change
