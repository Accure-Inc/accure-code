...
import type { AccurecodeNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<AccurecodeNotification[]>
  filteredNotifications: Accessor<AccurecodeNotification[]>
