...
import { writeToolOpen } from "../../../../accure-ui/src/components/tool-open-state"
...
const hits = [
  'packages/accure-ui/src/components/message-part.tsx:1847: <div data-component="tool-output">',
  'packages/accure-ui/src/components/basic-tool.css:250: [data-component="tool-output"]',
  "packages/accure-vscode/webview-ui/src/components/chat/VscodeToolOverrides.tsx:141: background process output",
].join("\n")
...
const proc = [
  ...
  "status: running",
  "cwd: /project",
  "command: bun run --cwd packages/accure-vscode storybook",
  "last_output:",
...
const gapPatch = [
  "===================================================================",
  "--- packages/accure-ui/src/components/message-part.css",
  "+++ packages/accure-ui/src/components/message-part.css",
  "@@ -560,5 +560,5 @@",
  ' html[data-theme="accure-vscode"] [data-component="reasoning-part"] {',
...
const writePatch = [
  "===================================================================",
  "--- packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "+++ packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
  "@@ -1,3 +1,4 @@",
  " /** @jsxImportSource solid-js */",
...
const blocks: SDKPart[] = [
  ...
  bash(
    ...
    "matrix-call-bash",
    "Run visual check",
    "bun run --cwd packages/accure-vscode build-storybook",
  ...
  tool(
    ...
    "grep",
    completed(
      { pattern: "tool-collapsible", include: "*.css", path: "packages/accure-ui/src/components" },
      "Find gaps",
      hits,
    ),
  ),
  ...
  tool("matrix-edit", "matrix-call-edit", "edit", {
    status: "completed",
    input: {
      filePath: "packages/accure-ui/src/components/message-part.css",
      oldString: "gap: 4px;",
      newString: "gap: 8px;",
    },
    output: "",
    ...
    metadata: {
      filediff: {
        file: "packages/accure-ui/src/components/message-part.css",
        patch: gapPatch,
        additions: 1,
        deletions: 1,
      },
  ...
  tool("matrix-write", "matrix-call-write", "write", {
    status: "completed",
    input: {
      filePath: "packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
    ...
    metadata: {
      filediff: {
        file: "packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
        patch: writePatch,
        additions: 1,
        deletions: 0,
      },
  ...
  tool("matrix-patch", "matrix-call-patch", "apply_patch", {
    ...
    metadata: {
      files: [
        {
          filePath: "/project/packages/accure-ui/src/components/message-part.css",
          relativePath: "packages/accure-ui/src/components/message-part.css",
          type: "update",
          patch: gapPatch,
          diff: gapPatch,
          additions: 1,
        ...
        {
          filePath: "/project/packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          relativePath: "packages/accure-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx",
          type: "update",
          patch: writePatch,
          diff: writePatch,
          additions: 1,
  ...
  tool(
    ...
    "edit",
    failed({ filePath: "packages/accure-ui/src/components/message-part.css" }, "oldString and newString are identical"),
  ),
  tool(
    "matrix-tool-error",
