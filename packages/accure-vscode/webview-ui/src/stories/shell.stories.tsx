...
import type { AssistantMessage, ToolPart } from "@accurecode/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/accure-vscode/webview-ui/src/types/messages.ts`,
    },
