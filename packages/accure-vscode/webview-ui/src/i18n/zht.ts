...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Accure 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Accure 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Accure 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Accure 中使用 {{provider}} 模型。",
  ...
  "speechToText.tooltip.start": "使用 Accure Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 Accure 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Accure 伺服器。",
  ...
  "toast.update.description": "Accure 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Accure 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Accure 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Accure 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Accure 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Accure 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Accure 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Accure 啟動時自動檢查更新",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Accure Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Accure 開放，絕不綁定。",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Accure Gateway 模型。",
  ...
  "settings.config.title": "開啟 {{scope}} Accure 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Accure 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Accure 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeAccure": "主目錄 .accurecode 設定",
  "settings.config.source.homeAccurecode": "主目錄 .accurecode 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "ACCURECODE_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "ACCURECODE_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectAccure": "專案 .accurecode 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectAccurecode": "舊版 .accurecode 設定",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Accure",
  ...
  "workStyle.choice.human-in-the-loop.description": "Accure 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 accure import 指令",
  ...
  "deviceAuth.title": "登入 Accure Code",
  ...
  "profile.action.login": "使用 Accure Code 登入",
  ...
  "settings.aboutAccureCode.title": "關於 Accure Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Accure Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutAccureCode.status.connected": "已連線",
  "settings.aboutAccureCode.status.connecting": "連線中...",
  "settings.aboutAccureCode.status.disconnected": "已中斷",
  "settings.aboutAccureCode.status.error": "錯誤",
  "settings.aboutAccureCode.cliServer": "CLI 伺服器",
  "settings.aboutAccureCode.status.label": "狀態：",
  "settings.aboutAccureCode.port.label": "連接埠：",
  "settings.aboutAccureCode.versionInfo": "版本資訊",
  "settings.aboutAccureCode.version.label": "版本：",
  "settings.aboutAccureCode.extensionName": "Accure Code 擴充功能",
  "settings.aboutAccureCode.community": "社群與支援",
  "settings.aboutAccureCode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutAccureCode.feedback.or": "或",
  "settings.aboutAccureCode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutAccureCode.resetSettings.title": "重置設定",
  "settings.aboutAccureCode.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutAccureCode.resetSettings.button": "重置所有設定",
  "settings.aboutAccureCode.settingsTransfer.title": "設定轉移",
  "settings.aboutAccureCode.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutAccureCode.exportSettings": "匯出",
  "settings.aboutAccureCode.importSettings": "匯入",
  "settings.aboutAccureCode.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutAccureCode.importSettings.invalidConfig": "檔案不包含有效的 Accure 設定。",
  "settings.aboutAccureCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutAccureCode.importSettings.newerVersion": "此檔案由較新版本的 Accure 匯出。部分設定可能會被忽略。",
  "settings.aboutAccureCode.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutAccureCode.telemetry.title": "遙測",
  "settings.aboutAccureCode.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutAccureCode.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Accure Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.speechToText.description":
    "透過 Accure Gateway 使用您的 Accure 帳戶在提示詞欄位中啟用語音輸入。",
  "settings.models.speechToText.disabledDescription":
    "啟用並登入 Accure 供應商以使用 Speech to Text。Speech to Text 目前僅支援透過 Accure Gateway 使用。",
  "settings.models.speechToTextModel.title": "語音轉文字模型",
  "settings.models.speechToTextModel.description": "選擇用於語音輸入的 Accure Gateway 轉錄模型。",
  ...
  "settings.experimental.remote.description":
    "透過 Accure Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Accure 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 accure.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Accure webview UI 的字體大小。",
  ...
  "settings.indexing.accureModel.title": "Accure 模型預設",
  "settings.indexing.accureModel.description": "選擇支援的 Accure 託管嵌入模型。",
  "settings.indexing.accureSignIn.title": "需要登入 Accure",
  "settings.indexing.accureSignIn.description": "登入 Accure 以使用託管嵌入。",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "舊版遷移",
  "settings.aboutAccureCode.legacyMigration.description":
    "從舊版 Accure Code 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
  "settings.aboutAccureCode.rooImport.description": "從 Roo Code 安裝匯入對話歷史記錄。",
  "settings.aboutAccureCode.rooImport.button": "從 Roo Code 匯入工作階段",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Accure 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Accure 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
