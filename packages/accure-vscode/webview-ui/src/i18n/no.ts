...
export const dict = {
  ...
  "deviceAuth.title": "Logg inn på Accure Code",
  ...
  "profile.action.login": "Logg inn med Accure Code",
  ...
  "session.messages.welcome":
    "Accure Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.language.description": 'Velg språket for Accure Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
