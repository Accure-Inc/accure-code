export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Accure",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Accure.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Accure.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Accure.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Accure Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Accure pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Accure auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Accure ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Accure",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Accure ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Accure inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Accure",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Accure sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Accure.",
  ...
  "settings.indexing.accureModel.title": "Préréglage de modèle Accure",
  "settings.indexing.accureModel.description": "Choisissez un modèle d'embedding hébergé par Accure pris en charge.",
  "settings.indexing.accureSignIn.title": "Connexion à Accure requise",
  "settings.indexing.accureSignIn.description": "Connectez-vous à Accure pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Accure",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Accure.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Accure Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Accure ouvert, sans enfermement propriétaire.",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Accure Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Accure {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Accure local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Accure {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeAccure": "Configuration .accurecode de Home",
  "settings.config.source.homeAccurecode": "Configuration .accurecode de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement ACCURECODE_CONFIG",
  ...
  "settings.config.source.projectAccure": "Configuration .accurecode du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectAccurecode": "Configuration obsolète .accurecode",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Accure",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Accure s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande accure import",
  ...
  "deviceAuth.title": "Se connecter à Accure Code",
  ...
  "profile.action.login": "Se connecter avec Accure Code",
  ...
  "settings.aboutAccureCode.title": "À propos de Accure Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Accure Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutAccureCode.status.connected": "Connecté",
  "settings.aboutAccureCode.status.connecting": "Connexion en cours...",
  "settings.aboutAccureCode.status.disconnected": "Déconnecté",
  "settings.aboutAccureCode.status.error": "Erreur",
  "settings.aboutAccureCode.cliServer": "Serveur CLI",
  "settings.aboutAccureCode.status.label": "Statut :",
  "settings.aboutAccureCode.port.label": "Port :",
  "settings.aboutAccureCode.versionInfo": "Informations de version",
  "settings.aboutAccureCode.version.label": "Version :",
  "settings.aboutAccureCode.extensionName": "Extension Accure Code",
  "settings.aboutAccureCode.community": "Communauté et support",
  ...
  "settings.aboutAccureCode.resetSettings.title": "Réinitialiser les paramètres",
  ...
  "settings.aboutAccureCode.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutAccureCode.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutAccureCode.exportSettings": "Exporter",
  ...
  "settings.aboutAccureCode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Accure valides.",
  ...
  "settings.aboutAccureCode.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Accure. Certains paramètres pourraient être ignorés.",
  ...
  "settings.aboutAccureCode.telemetry.title": "Télémétrie",
  ...
  "settings.aboutAccureCode.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Accure Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Accure via Accure Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Accure pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Accure Gateway.",
  "settings.models.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.models.speechToTextModel.description":
    "Choisissez le modèle de transcription Accure Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Accure Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Accure utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans accure.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Accure indépendamment de VS Code.",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutAccureCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Accure Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  ...
  "settings.aboutAccureCode.rooImport.button": "Importer les sessions depuis Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Accure Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Accure. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Accure pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
