export const dict = {
  ...
  "deviceAuth.title": "Prijavite se u Accure Code",
  ...
  "profile.action.login": "Prijavite se putem Accure Code",
  ...
  "session.messages.welcome":
    "Accure Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.language.description": 'Odaberite jezik za Accure Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
