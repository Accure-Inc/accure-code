...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Accure 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Accure 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Accure 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Accure 中使用 {{provider}} 模型。",
  ...
  "speechToText.tooltip.start": "使用 Accure Gateway 开始语音输入",
  ...
  "speechToText.error.loginRequired": "登录 Accure 以使用语音输入。",
  ...
  "dialog.server.description": "切换此应用连接的 Accure 服务器。",
  ...
  "toast.update.description": "Accure 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Accure 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Accure 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Accure 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Accure 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Accure 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Accure 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Accure 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Accure。",
  ...
  "settings.indexing.accureModel.title": "Accure 模型预设",
  "settings.indexing.accureModel.description": "选择受支持的 Accure 托管嵌入模型。",
  "settings.indexing.accureSignIn.title": "需要登录 Accure",
  "settings.indexing.accureSignIn.description": "登录 Accure 以使用托管嵌入。",
  ...
  "settings.providers.betaNotice":
    "目前只能在设置界面中配置 Accure Gateway 提供商。在 Beta 测试期间即将支持配置其他提供商。在此期间，您可以使用 CLI 或配置文件来配置提供商。我们致力于保持 Accure 开放，无锁定。",
  ...
  "settings.models.hidePromptTraining.description": "隐藏提供商可能会使用您的提示词进行训练的 Accure Gateway 模型。",
  ...
  "settings.config.title": "打开 {{scope}} Accure 配置文件",
  "settings.config.placeholder": "配置文件按顺序合并；标记为已加载的文件目前会影响设置。",
  "settings.config.noWorkspace": "打开工作区文件夹以编辑本地 Accure 配置文件。",
  "settings.config.openFailed": "无法打开 {{scope}} Accure 配置文件：{{message}}",
  "settings.config.source.xdg": "XDG 全局配置",
  "settings.config.source.homeAccure": "主目录 .accurecode 配置",
  "settings.config.source.homeAccurecode": "主目录 .accurecode 配置",
  "settings.config.source.homeOpencode": "主目录 .opencode 配置",
  "settings.config.source.envFile": "ACCURECODE_CONFIG 环境变量文件",
  "settings.config.source.envDir": "ACCURECODE_CONFIG_DIR",
  "settings.config.source.envContent": "内联环境配置",
  "settings.config.source.projectAccure": "项目 .accurecode 配置",
  "settings.config.source.projectRoot": "项目根目录配置",
  "settings.config.source.projectAccurecode": "旧版 .accurecode 配置",
  ...
  "workStyle.onboarding.welcome": "欢迎使用 Accure",
  ...
  "workStyle.choice.human-in-the-loop.description": "Accure 会在工作过程中暂停并向你展示其计划。",
  ...
  "session.cloud.import.placeholder": "会话 ID、URL 或 accure import 命令",
  ...
  "deviceAuth.title": "登录 Accure Code",
  ...
  "profile.action.login": "使用 Accure Code 登录",
  ...
  "settings.aboutAccureCode.title": "关于 Accure Code",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "Accure Code 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutAccureCode.status.connected": "已连接",
  "settings.aboutAccureCode.status.connecting": "连接中...",
  "settings.aboutAccureCode.status.disconnected": "已断开",
  "settings.aboutAccureCode.status.error": "错误",
  "settings.aboutAccureCode.cliServer": "CLI 服务器",
  "settings.aboutAccureCode.status.label": "状态：",
  "settings.aboutAccureCode.port.label": "端口：",
  "settings.aboutAccureCode.versionInfo": "版本信息",
  "settings.aboutAccureCode.version.label": "版本：",
  "settings.aboutAccureCode.extensionName": "Accure Code 扩展",
  "settings.aboutAccureCode.community": "社区与支持",
  "settings.aboutAccureCode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutAccureCode.feedback.or": "或",
  "settings.aboutAccureCode.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutAccureCode.resetSettings.title": "重置设置",
  "settings.aboutAccureCode.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutAccureCode.resetSettings.button": "重置所有设置",
  "settings.aboutAccureCode.settingsTransfer.title": "设置迁移",
  "settings.aboutAccureCode.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutAccureCode.exportSettings": "导出",
  "settings.aboutAccureCode.importSettings": "导入",
  "settings.aboutAccureCode.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutAccureCode.importSettings.invalidConfig": "文件不包含有效的 Accure 设置。",
  "settings.aboutAccureCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutAccureCode.importSettings.newerVersion": "此文件由较新版本的 Accure 导出。部分设置可能会被忽略。",
  "settings.aboutAccureCode.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutAccureCode.telemetry.title": "遥测",
  "settings.aboutAccureCode.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutAccureCode.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 Accure Code 界面的语言。',
  ...
  "settings.experimental.speechToText.description":
    "通过 Accure Gateway 使用您的 Accure 帐户在提示词字段中启用语音输入。",
  "settings.models.speechToText.disabledDescription":
    "启用并登录 Accure 提供商以使用 Speech to Text。Speech to Text 目前仅支持通过 Accure Gateway 使用。",
  "settings.models.speechToTextModel.title": "语音转文本模型",
  "settings.models.speechToTextModel.description": "选择用于语音输入的 Accure Gateway 转录模型。",
  ...
  "settings.experimental.remote.description": "通过 Accure Cloud 启用会话的 Remote 控制。这也会影响此计算机上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "将 Claude Code 配置目录中的 CLAUDE.md 指令和技能加载到会话中。如果您希望 Accure 使用您的 Claude Code 指令和技能，请启用此选项。需要重启。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。在 accure.jsonc 中添加 MCP 服务器，或让代理为您添加。",
  ...
  "settings.display.fontSize.description": "独立于 VS Code 调整 Accure webview UI 的字体大小。",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "旧版迁移",
  "settings.aboutAccureCode.legacyMigration.description":
    "从旧版 Accure Code 安装迁移设置，包括提供商 API 密钥和默认模型。",
  "settings.aboutAccureCode.rooImport.description": "从 Roo Code 安装导入对话历史记录。",
  "settings.aboutAccureCode.rooImport.button": "从 Roo Code 导入会话",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Accure Code 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Accure 产品共享一个小巧高效的核心。无论你选择哪种方式工作，都能获得熟悉的体验。",
  ...
  "diffViewer.source.session.tooltip": "Accure 在当前会话中更改的文件，基于每轮快照。开始新会话时重置。",
