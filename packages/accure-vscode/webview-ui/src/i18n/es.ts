export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Accure",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Accure.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Accure.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Accure.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Accure Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Accure para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Accure se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Accure ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Accure",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Accure no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Accure incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Accure",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Accure en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Accure.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Accure",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Accure.",
  ...
  "settings.indexing.accureModel.title": "Preajuste de modelo de Accure",
  "settings.indexing.accureModel.description": "Elige un modelo de embeddings alojado por Accure compatible.",
  "settings.indexing.accureSignIn.title": "Se requiere iniciar sesión en Accure",
  "settings.indexing.accureSignIn.description": "Inicia sesión en Accure para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Accure Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Accure abierto, sin ataduras.",
  ...
  "settings.models.hidePromptTraining.description":
    "Oculta los modelos de Accure Gateway cuyos proveedores pueden usar tus prompts para entrenamiento.",
  ...
  "settings.config.title": "Abrir archivo de configuración Accure {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Accure local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Accure {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeAccure": "Configuración .accurecode de Home",
  "settings.config.source.homeAccurecode": "Configuración .accurecode de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno ACCURECODE_CONFIG",
  "settings.config.source.envDir": "ACCURECODE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectAccure": "Configuración .accurecode del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectAccurecode": "Configuración heredada .accurecode",
  ...
  "workStyle.onboarding.welcome": "Te damos la bienvenida a Accure",
  ...
  "workStyle.choice.human-in-the-loop.description": "Accure se detiene y te muestra su plan mientras trabaja.",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando accure import",
  ...
  "deviceAuth.title": "Iniciar sesión en Accure Code",
  ...
  "profile.action.login": "Iniciar sesión con Accure Code",
  ...
  "settings.aboutAccureCode.title": "Acerca de Accure Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Accure Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutAccureCode.status.connected": "Conectado",
  "settings.aboutAccureCode.status.connecting": "Conectando...",
  "settings.aboutAccureCode.status.disconnected": "Desconectado",
  "settings.aboutAccureCode.status.error": "Error",
  "settings.aboutAccureCode.cliServer": "Servidor CLI",
  "settings.aboutAccureCode.status.label": "Estado:",
  "settings.aboutAccureCode.port.label": "Puerto:",
  "settings.aboutAccureCode.versionInfo": "Información de versión",
  "settings.aboutAccureCode.version.label": "Versión:",
  "settings.aboutAccureCode.extensionName": "Extensión Accure Code",
  "settings.aboutAccureCode.community": "Comunidad y soporte",
  "settings.aboutAccureCode.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutAccureCode.feedback.or": "o",
  "settings.aboutAccureCode.support.prefix":
    "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutAccureCode.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutAccureCode.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutAccureCode.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutAccureCode.exportSettings": "Exportar",
  "settings.aboutAccureCode.importSettings": "Importar",
  "settings.aboutAccureCode.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutAccureCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Accure.",
  ...
  "settings.aboutAccureCode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Accure. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutAccureCode.telemetry.title": "Telemetría",
  ...
  "settings.aboutAccureCode.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Accure Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Accure a través de Accure Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Accure para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Accure Gateway.",
  "settings.models.speechToTextModel.title": "Modelo de voz a texto",
  "settings.models.speechToTextModel.description":
    "Elige el modelo de transcripción de Accure Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Accure Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Accure utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en accure.jsonc o pida al agente que los añada.",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Accure de forma independiente a VS Code.",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "Migración heredada",
  "settings.aboutAccureCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Accure Code, incluyendo las claves API de proveedores y el modelo predeterminado.",
  "settings.aboutAccureCode.rooImport.description":
    "Importa el historial de conversaciones de una instalación de Roo Code.",
  "settings.aboutAccureCode.rooImport.button": "Importar sesiones desde Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Accure Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Accure. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Accure durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
