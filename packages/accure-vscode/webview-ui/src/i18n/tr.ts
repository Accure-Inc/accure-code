export const dict = {
  ...
  "deviceAuth.title": "Accure Code'a giriş yap",
  ...
  "profile.action.login": "Accure Code ile giriş yap",
  ...
  "session.messages.welcome":
    "Accure Code bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Accure Code arayüzü için dil seçin.',
