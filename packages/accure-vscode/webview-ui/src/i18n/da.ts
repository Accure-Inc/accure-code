export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Accure",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Accure.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Accure.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Accure.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Accure Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Accure for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken Accure-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Accure ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Accure-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Accure understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Accure inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Accure",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Accure ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Accure er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Accure starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Accure.",
  ...
  "settings.indexing.accureModel.title": "Accure-modelpreset",
  "settings.indexing.accureModel.description": "Vælg en understøttet Accure-hostet embedding-model.",
  "settings.indexing.accureSignIn.title": "Accure-login kræves",
  "settings.indexing.accureSignIn.description": "Log ind på Accure for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Accure Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Accure åben, ingen lock-in.",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Accure Gateway-modeller, hvis udbydere muligvis bruger dine prompts til træning.",
  ...
  "settings.config.title": "Åbn {{scope}} Accure konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Accure konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Accure konfigurationsfil: {{message}}",
  ...
  "settings.config.source.projectAccurecode": "Forældet .accurecode konfiguration",
  ...
  "workStyle.choice.human-in-the-loop.description": "Accure holder pause og viser dig sin plan undervejs.",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller accure import-kommando",
  ...
  "deviceAuth.title": "Log ind på Accure Code",
  ...
  "profile.action.login": "Log ind med Accure Code",
  ...
  "session.messages.welcome":
    "Accure Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutAccureCode.status.connected": "Forbundet",
  "settings.aboutAccureCode.status.connecting": "Forbinder...",
  "settings.aboutAccureCode.status.disconnected": "Afbrudt",
  "settings.aboutAccureCode.status.error": "Fejl",
  ...
  "settings.aboutAccureCode.versionInfo": "Versionsinformation",
  "settings.aboutAccureCode.version.label": "Version:",
  "settings.aboutAccureCode.extensionName": "Accure Code-udvidelse",
  "settings.aboutAccureCode.community": "Fællesskab og support",
  ...
  "settings.aboutAccureCode.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutAccureCode.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutAccureCode.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutAccureCode.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutAccureCode.exportSettings": "Eksportér",
  "settings.aboutAccureCode.importSettings": "Importér",
  "settings.aboutAccureCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutAccureCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Accure-indstillinger.",
  "settings.aboutAccureCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutAccureCode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Accure. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutAccureCode.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Accure Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din Accure-konto gennem Accure Gateway.",
  "settings.models.speechToText.disabledDescription":
    "Aktivér og log ind på Accure-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Accure Gateway.",
  "settings.models.speechToTextModel.title": "Model til tale til tekst",
  "settings.models.speechToTextModel.description": "Vælg Accure Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Accure Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Accure til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i accure.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Accure webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "Legacy-migrering",
  "settings.aboutAccureCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Accure Code, herunder udbyder API-nøgler og standardmodel.",
  "settings.aboutAccureCode.rooImport.description": "Importer samtalehistorik fra en installation af Roo Code.",
  "settings.aboutAccureCode.rooImport.button": "Importer sessioner fra Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Accure Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Accure-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Accure i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
