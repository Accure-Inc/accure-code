export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Accure",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Accure.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Accure.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Accure.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Accure Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Accure لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم Accure الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Accure ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Accure",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Accure لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Accure نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Accure",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Accure على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Accure.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Accure",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Accure.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Accure Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Accure مفتوحاً، دون تقييد.",
  ...
  "settings.models.hidePromptTraining.description":
    "إخفاء نماذج Accure Gateway التي قد يستخدم مزودوها مطالباتك لأغراض التدريب.",
  ...
  "settings.config.title": "فتح ملف تكوين Accure {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Accure المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Accure {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeAccure": "تكوين .accurecode في Home",
  "settings.config.source.homeAccurecode": "تكوين .accurecode في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة ACCURECODE_CONFIG",
  "settings.config.source.envDir": "ACCURECODE_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectAccure": "تكوين .accurecode للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectAccurecode": "تكوين .accurecode القديم",
  ...
  "workStyle.onboarding.welcome": "مرحبًا بك في Accure",
  ...
  "workStyle.choice.human-in-the-loop.description": "يتوقف Accure مؤقتًا ويعرض لك خطته أثناء العمل.",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر accure import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Accure Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Accure Code",
  ...
  "settings.indexing.accureModel.title": "إعداد مسبق لنموذج Accure",
  "settings.indexing.accureModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Accure.",
  "settings.indexing.accureSignIn.title": "تسجيل الدخول إلى Accure مطلوب",
  "settings.indexing.accureSignIn.description": "سجّل الدخول إلى Accure لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutAccureCode.title": "حول Accure Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Accure Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutAccureCode.status.connected": "متصل",
  "settings.aboutAccureCode.status.connecting": "جارٍ الاتصال...",
  "settings.aboutAccureCode.status.disconnected": "غير متصل",
  "settings.aboutAccureCode.status.error": "خطأ",
  "settings.aboutAccureCode.cliServer": "خادم CLI",
  "settings.aboutAccureCode.status.label": "الحالة:",
  "settings.aboutAccureCode.port.label": "المنفذ:",
  "settings.aboutAccureCode.versionInfo": "معلومات الإصدار",
  "settings.aboutAccureCode.version.label": "الإصدار:",
  "settings.aboutAccureCode.extensionName": "إضافة Accure Code",
  "settings.aboutAccureCode.community": "المجتمع والدعم",
  "settings.aboutAccureCode.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutAccureCode.feedback.or": "أو",
  "settings.aboutAccureCode.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutAccureCode.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutAccureCode.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutAccureCode.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutAccureCode.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutAccureCode.exportSettings": "تصدير",
  "settings.aboutAccureCode.importSettings": "استيراد",
  "settings.aboutAccureCode.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutAccureCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Accure صالحة.",
  "settings.aboutAccureCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutAccureCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Accure. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutAccureCode.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",

  "settings.aboutAccureCode.telemetry.title": "Telemetry",
  ...
  "settings.aboutAccureCode.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Accure Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب Accure الخاص بك من خلال Accure Gateway.",
  "settings.models.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Accure لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Accure Gateway.",
  "settings.models.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.models.speechToTextModel.description": "اختر نموذج نسخ Accure Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Accure Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Accure مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في accure.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Accure بشكل مستقل عن VS Code.",
  ...
  "settings.aboutAccureCode.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutAccureCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Accure Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  "settings.aboutAccureCode.rooImport.description": "استيراد سجل المحادثات من تثبيت Roo Code.",
  "settings.aboutAccureCode.rooImport.button": "استيراد الجلسات من Roo Code",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Accure Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Accure. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Accure خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
