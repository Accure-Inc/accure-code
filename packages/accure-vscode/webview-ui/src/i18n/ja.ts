export const dict = {
  ...
  "deviceAuth.title": "Accure Codeにサインイン",
  ...
  "profile.action.login": "Accure Codeでログイン",
  ...
  "session.messages.welcome":
    "Accure CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.language.description": "Accure Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
