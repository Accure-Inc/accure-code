...
describe("promotion handoff", () => {
  it("describes the new worktree location", () => {
    const text = handoffText({ directory: "/repo/.accurecode/worktrees/feature", branch: "feature/test" })
    ...
    expect(promptAsync).toHaveBeenCalledWith(
      {
        ...
        parts: [
          {
            type: "text",
            text: handoffText({ directory: "/repo/.accurecode/worktrees/feature", branch: "feature/test" }),
            synthetic: true,
          },
        ],
      },
