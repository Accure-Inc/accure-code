 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "accure.autocomplete.inline-completion.accepted"
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "accure-code.autocomplete.hasSuggestions", true)
