...
export const registerAutocompleteProvider = async (
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.reload", async () => {
      await autocompleteManager.load()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.codeActionQuickFix", async () => {
      return
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.cancelSuggestions", () => {
      vscode.commands.executeCommand("editor.action.inlineSuggest.hide")
      vscode.commands.executeCommand("setContext", "accure-code.autocomplete.hasSuggestions", false)
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.generateSuggestions", async () => {
      autocompleteManager.codeSuggestion()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.showIncompatibilityExtensionPopup", async () => {
      await autocompleteManager.showIncompatibilityExtensionPopup()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.disable", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.nextEdit.acceptOrJump", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("accure-code.autocomplete.nextEdit.dismiss", () => {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (e.affectsConfiguration("accure-code.autocomplete")) {
