...
**Priority:** P0
**Issue:** [#6083](https://github.com/Accure-Inc/accure-code/issues/6083)
...
- Check if both versions attempt to spawn `accure serve` simultaneously causing port/race conflicts
