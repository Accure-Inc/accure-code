...
import ai.accurecode.backend.migration.LegacyAutocompleteSettings
...
import ai.accurecode.backend.migration.LegacyMigrationItemProgress
...
import ai.accurecode.backend.migration.LegacyMigrationSessionProgress
import ai.accurecode.backend.migration.LegacyMigrationStatus
import ai.accurecode.backend.migration.LegacySettings
import ai.accurecode.backend.migration.MigrationAutoApprovalSelections
import ai.accurecode.backend.migration.MigrationCustomModeInfo
import ai.accurecode.backend.migration.MigrationDefaultModelInfo
import ai.accurecode.backend.migration.MigrationItemCategory
import ai.accurecode.backend.migration.MigrationItemProgressStatus
import ai.accurecode.backend.migration.MigrationItemStatus
import ai.accurecode.backend.migration.MigrationMcpServerInfo
import ai.accurecode.backend.migration.MigrationProviderInfo
import ai.accurecode.backend.migration.MigrationSessionInfo
import ai.accurecode.backend.migration.MigrationSessionPhase
import ai.accurecode.backend.migration.MigrationSettingsSelections
import ai.accurecode.backend.migration.MigrationSessionSelection
...
import ai.accurecode.rpc.dto.LegacyMigrationItemProgressDto
...
import ai.accurecode.rpc.dto.MigrationCustomModeInfoDto
import ai.accurecode.rpc.dto.MigrationDefaultModelInfoDto
...
import ai.accurecode.rpc.dto.MigrationMcpServerInfoDto
