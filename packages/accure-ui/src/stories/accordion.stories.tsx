  ...
  render: () => (
    <Accordion collapsible defaultValue={["item-1"]}>
      <Accordion.Item value="item-1">
        <Accordion.Header>
          <Accordion.Trigger>What is Accure?</Accordion.Trigger>
        </Accordion.Header>
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Accure is an AI-powered coding assistant that helps you write, debug, and understand code.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-2">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Accure uses large language models to understand your codebase and provide intelligent suggestions.
          </div>
        </Accordion.Content>
      </Accordion.Item>
      <Accordion.Item value="item-3">
        ...
        <Accordion.Content>
          <div style={{ padding: "8px 16px" }}>
            Accure supports all major programming languages including TypeScript, Python, Go, Rust, and more.
          </div>
        </Accordion.Content>
      </Accordion.Item>
    </Accordion>
