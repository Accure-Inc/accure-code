//
// @accurecode/accure-ui
//
// Theme and style override layer for @opencode-ai/ui that matches the
// visual style of the legacy Accure Code VS Code extension.
//
// Two themes are provided:
// - accure:        For web/desktop (light + dark variants from legacy VS Code themes) [DEFAULT]
// - accure-vscode: For the VS Code extension (adapts to user's VS Code theme)
//
