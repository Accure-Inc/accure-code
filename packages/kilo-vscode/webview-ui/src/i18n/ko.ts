...
export const dict = {
  ...
  "deviceAuth.title": "Accure Code에 로그인",
  ...
  "profile.action.login": "Accure Code로 로그인",
  ...
  "session.messages.welcome":
    "Accure Code는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.language.description": 'Accure Code UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
